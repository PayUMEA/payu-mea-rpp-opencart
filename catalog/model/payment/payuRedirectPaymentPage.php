<?php 
class ModelPaymentPayuRedirectPaymentPage extends Model {
  	public function getMethod($address, $total) {
		...
		$method_data = array();
      		...
      		$method_data = array( 
        		'code'       => 'payuRedirectPaymentPage',
        		'title' => $this->config->get('payuRedirectPaymentPage_payTitle'),
				'sort_order' => $this->config->get('payuRedirectPaymentPage_sort_order')
      		);
